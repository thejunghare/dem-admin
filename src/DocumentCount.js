...
function DocumentCount() {
  ...
  const [singleDateRoomLockedTotalCount, setSingleDateRoomLockedTotalCount] =
    useState(0);
  const [
    singleDateSurveyDeniedTotalCount,
    setSingleDateSurveyDeniedTotalCount,
  ] = useState(0);
  ...
  const [rangeSurveyDeniedTotalCount, setRangeSurveyDeniedTotalCount] =
    useState(0);
  ...
  const fetchEmpRangeCount = async () => {
    try {
      ...
      const [
        empRangeResponse,
        roomLockedRangeResponse,
        surveyDeniedRangeResponse,
      ] = await Promise.all([
        databases.listDocuments(databaseId, collectionId, empRangeQueries),
        databases.listDocuments(
          databaseId,
          collectionId,
          roomLockedRangeQueries
        ),
        databases.listDocuments(
          databaseId,
          collectionId,
          surveyDeniedRangeQueries
        ),
      ]);
    ...
    <div>
      <div className={"count_container"}>
        <div>
          ...
          />
          <button
            onClick={fetchSingleDateTotalCount}
            className={"get_count_button"}
          >
            Get count
          </button>
          <button
            onClick={resetSingleDateTotalCount}
            className={"reset_count_button"}
          >
            Clear
          </button>
        ...
        <div>
          ...
          <input
            ...
            placeholder="To Date"
          />
          <button onClick={fetchRangeTotalCount} className={"get_count_button"}>
            Get count
          </button>
          <button
            onClick={resetRangeTotalCount}
            className={"reset_count_button"}
          >
            Clear
          </button>
      ...
      <div className={"count_container"}>
        <div>
          ...
          />
          <button onClick={fetchEmpCount} className={"get_count_button"}>
            Get count
          </button>
          <button onClick={resetEmpCount} className={"reset_count_button"}>
            Clear
          </button>
          <p>
        ...
        <div>
          ...
          <input
            ...
            placeholder="To Date"
          />
          <button onClick={fetchEmpRangeCount} className={"get_count_button"}>
            Get count
          </button>
          <button onClick={resetEmpRangeCount} className={"reset_count_button"}>
            Clear
          </button>
          <p>
            Count for {empId} from {empRangeFromDate} to {empRangeToDate}:{" "}
            {empRangeCount}
          </p>
